        ...
        <section class="bg-white  ">
            <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
                <div class="flex flex-col items-center max-w-sm mx-auto text-center">
                    ...
                    <h1 class="mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">Halaman Tidak
                        Ditemukan</h1>
                    <p class="mt-4 text-gray-500 ">The page you are looking for doesn't exist. Here are
